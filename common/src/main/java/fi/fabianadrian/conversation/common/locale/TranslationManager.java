package fi.fabianadrian.conversation.common.locale;
...
public final class TranslationManager {
	...
	public TranslationManager(Logger logger, Path translationsDirectory) {
		this.logger = logger;
	...
	public void reload() {
		...
		this.registry = TranslationRegistry.create(Key.key("conversation", "main"));
